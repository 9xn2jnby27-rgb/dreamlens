...
// ─── SMART DREAM ANALYSIS ENGINE ─────────────────────────────────────────────
const DREAM_KB = [
  { keys: ["vol","voler","volais","envol","planer","ailes"],
    analyses: [
      "Voler symbolise une soif de liberté et de transcendance que ton inconscient exprime avec force. Cette élévation au-dessus du monde ordinaire traduit une confiance en toi qui grandit, un désir de surpasser les obstacles qui t'entourent. Les rêves de vol sont souvent associés à une période de croissance personnelle intense.",
      "L'envol dans tes rêves est l'un des symboles les plus puissants de l'inconscient jungien — il représente l'âme qui cherche à se libérer de ses chaînes terrestres. Cette légèreté ressentie suggère que tu traverses une phase où tes ambitions prennent leur essor. Laisse-toi porter par ce souffle.",
    ]},
  { keys: ["eau","mer","océan","rivière","lac","pluie","nager","flot","vague","noyé"],
    analyses: [
      "L'eau est le miroir de l'inconscient — profonde, mouvante, insaisissable. Sa présence dans ton rêve indique une période de transformation émotionnelle importante. Les eaux calmes évoquent la paix intérieure qui s'installe ; les eaux agitées, des émotions encore à apprivoiser.",
      "Symbole universel des émotions et de l'inconscient collectif, l'eau de ton rêve parle de ta vie émotionnelle avec une clarté saisissante. Jung voyait dans l'eau le reflet de ce que nous n'osons pas encore regarder en face. Quelque chose cherche à remonter à la surface.",
    ]},
  { keys: ["maison","chambre","pièce","couloir","escalier","porte","fenêtre","grenier","cave"],
    analyses: [
      "La maison dans les rêves est une représentation directe de ton psyché — chaque pièce correspond à une facette de ta personnalité. Les espaces inconnus que tu traverses symbolisent des aspects de toi-même encore inexplorés. Cette exploration intérieure est un signe de maturité psychologique.",
      "Archétype freudien par excellence, la maison de ton rêve est ton propre moi mis en scène. Les pièces secrètes représentent les pensées refoulées, les escaliers symbolisent ton évolution entre différents états de conscience. Ton inconscient t'invite à explorer ses recoins.",
    ]},
  { keys: ["chute","tomber","tombais","précipice","vide","abîme","glisser"],
    analyses: [
      "La chute est l'un des rêves les plus universels — elle traduit une perte de contrôle ressentie dans ta vie éveillée, une situation où tu te sens dépassé. Paradoxalement, ces rêves sont souvent libérateurs : ils permettent de prendre conscience d'une tension que tu portais sans le savoir.",
      "Tomber en rêve est un signal de ton inconscient face à une situation qui t'échappe. Ce vertige symbolique indique un lâcher-prise nécessaire, une invitation à accepter que tout ne peut pas être maîtrisé. La chute précède toujours un nouveau sol, un nouveau départ.",
    ]},
  { keys: ["poursuite","poursuivi","fuir","fuite","courir","chassé","peur","monstre","danger"],
    analyses: [
      "Être poursuivi en rêve révèle quelque chose que tu évites d'affronter dans ta vie — une émotion, une décision, une conversation difficile. Ton poursuivant n'est autre que cette partie de toi que tu refuses de regarder en face. Le courage de se retourner dans le rêve symbolise la résolution du conflit.",
      "La fuite onirique est le langage de l'évitement — ton esprit met en scène ce que tu n'oses pas encore affronter. Plus tu cours vite, plus le problème semble urgent. C'est une invitation bienveillante de ton inconscient à faire face à ce qui te pèse.",
    ]},
  { keys: ["mort","mourir","décès","enterrement","fantôme","disparaître","fin"],
    analyses: [
      "Contrairement aux apparences, rêver de mort est presque toujours un symbole de transformation, jamais de mauvais augure. Jung y voyait la fin d'un cycle et le début d'un autre — une partie de toi doit mourir pour qu'une nouvelle version puisse naître. C'est un rêve d'évolution profonde.",
      "La mort dans les rêves est une métaphore puissante du changement. Elle annonce la fin d'une phase de ta vie — une relation, une croyance, une façon d'être — pour faire place à quelque chose de nouveau. Ton inconscient prépare le terrain pour une renaissance.",
    ]},
  { keys: ["enfant","bébé","enfance","jouet","école","passé","souvenir"],
    analyses: [
      "L'enfant qui apparaît dans tes rêves est l'archétype jungien de l'enfant intérieur — cette part de toi qui conserve la créativité, la spontanéité et la vulnérabilité originelles. Sa présence suggère un besoin de reconnecter avec tes aspirations les plus authentiques, celles d'avant les conditionnements.",
      "Rêver d'enfance ou d'enfants traduit souvent un besoin de retour aux sources, à une simplicité perdue. Ton inconscient te rappelle que certaines vérités essentielles ont été enfouies sous les couches de l'âge adulte. Il est temps de les retrouver.",
    ]},
  { keys: ["animal","loup","lion","serpent","oiseau","chat","chien","cheval","araignée","tigre"],
    analyses: [
      "Les animaux dans les rêves incarnent les forces instinctives et archétypales de notre nature profonde. Cet animal est un messager de ton inconscient qui te parle dans le langage des symboles primaires. Sa puissance ou sa douceur reflète la façon dont tu vis tes propres instincts.",
      "Selon Jung, les animaux représentent l'ombre — ces aspects de notre personnalité que la civilisation nous a appris à réprimer. La rencontre avec cet animal en rêve est une invitation à intégrer cette énergie brute et authentique dans ta vie consciente.",
    ]},
  { keys: ["forêt","bois","arbres","nature","montagne","désert","île","jardin"],
    analyses: [
      "La nature sauvage en rêve est le territoire de l'inconscient non domestiqué. Cette forêt ou ce paysage représente les parties de toi encore à explorer, à la fois menaçantes et pleines de promesses. T'aventurer dans cet espace symbolique demande courage et curiosité.",
      "Les grands espaces naturels dans les rêves évoquent l'âme dans son état le plus pur, avant les constructions sociales. Ce paysage est un miroir de ton état intérieur profond — sa beauté ou sa rudesse parle directement de ce que tu vis en ce moment.",
    ]},
  { keys: ["lumière","soleil","étoile","feu","flamme","obscurité","nuit","ombre"],
    analyses: [
      "La lumière en rêve est universellement associée à la conscience, à la clarté et à l'éveil spirituel. Sa présence dans ton rêve signale une prise de conscience imminente ou déjà en cours. Quelque chose qui était dans l'ombre commence à être éclairé.",
      "Lumière et obscurité dans les rêves jouent avec les archétypes les plus fondamentaux de la psyché. Ce jeu d'ombre et de lumière traduit la tension créatrice entre ce que tu sais et ce que tu pressentis, entre la certitude et le mystère.",
    ]},
];

const MOOD_ANALYSES = {
  "serein": "Cette sérénité ressentie dans ton rêve est un message précieux de ton inconscient — un signal que tu es sur la bonne voie, en harmonie avec toi-même. Profite de cette paix intérieure et laisse-la guider tes décisions à l'état de veille.",
  "mystérieux": "Le voile de mystère qui entoure ce rêve est caractéristique des messages les plus profonds de l'inconscient. Ce que tu ne comprends pas encore est souvent ce qui a le plus à t'apprendre. Laisse les symboles infuser lentement.",
  "euphorique": "Cette euphorie onirique est une réserve d'énergie positive que ton inconscient constitue pour toi. Elle reflète un alignement intérieur fort, une joie authentique qui cherche à s'exprimer dans ta vie quotidienne.",
  "angoissant": "L'angoisse de ce rêve est un signal d'alarme bienveillant de ton inconscient — il attire ton attention sur quelque chose qui mérite d'être regardé en face. Ces rêves difficiles sont souvent les plus transformateurs.",
  "étrange": "L'étrangeté de ce rêve est sa force même — l'inconscient parle souvent en métaphores absurdes pour contourner les résistances de la pensée rationnelle. Chaque élément bizarre est un symbole qui attend d'être décodé.",
  "épique": "La dimension épique de ce rêve traduit des enjeux intérieurs majeurs. Ton inconscient te met en scène comme héros de ta propre odyssée — les défis rencontrés symbolisent les obstacles réels que tu es en train de surmonter.",
};

function analyzeDream(dreamText, mood) {
  return new Promise((resolve) => {
    setTimeout(() => {
      const text = dreamText.toLowerCase();
      let found = null;
      for (const entry of DREAM_KB) {
      ...
      let analysis = "";
      if (found) {
        analysis = found.analyses[Math.floor(Math.random() * found.analyses.length)];
      } else {
        const moodAnalysis = MOOD_ANALYSES[mood] || MOOD_ANALYSES["mystérieux"];
        const generic = [
          "Ton rêve convoque des symboles personnels que seul ton inconscient comprend pleinement. Les images qui t'ont le plus frappé méritent d'être notées — elles forment un langage unique que tu apprendras à déchiffrer au fil du temps.",
          "Ce rêve échappe aux catégories communes, signe qu'il touche à quelque chose de très particulier dans ta psyché. Les détails qui t'ont marqué à ton réveil sont précisément ceux qui portent le plus de sens.",
          "L'inconscient s'exprime ici avec une originalité qui lui est propre. Plutôt que de chercher une interprétation unique, laisse ce rêve résonner en toi — sa signification se révélera progressivement.",
        ];
        analysis = moodAnalysis + " " + generic[Math.floor(Math.random() * generic.length)];
      }
      resolve(analysis);
    }, 2200);
  });
