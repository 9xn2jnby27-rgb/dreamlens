...
const KB = [
  ...
  { keys:["enfant","bébé","enfance","jouet","petit","bambin","nourrisson","grossesse","naissance"],
    i:[
  ...
  { keys:["feu","flamme","incendie","brûler","brûlait","fumée","chaleur","explosion"],
    i:[
      "Le feu est l'archétype de la transformation par excellence — il détruit pour mieux recréer. Sa présence signale une énergie puissante qui cherche à s'exprimer, une passion ou une colère que tu n'as pas encore laissé s'exprimer pleinement. Freud y voyait la libido dans sa forme la plus brûlante.",
  ...
  { keys:["lumière","soleil","étoile","briller","éblouissant","obscurité","ténèbres","ombre","nuit","noir","lampe"],
    i:[
  ...
  { keys:["amour","embrasser","baiser","séduction","couple","ex","partenaire","rencontre","attirer","relation","rupture","jalousie","tromperie","infidèle"],
    i:[
      "Les rêves amoureux mettent en scène l'anima ou l'animus jungien — ces figures intérieures qui incarnent les qualités que nous cherchons à intégrer. La personne que tu rencontres symbolise souvent une qualité que tu veux développer en toi-même.",
      "L'amour dans les rêves parle de tes besoins d'intimité et de connexion les plus profonds. Une rupture ou une trahison en rêve signale souvent une trahison envers toi-même, pas envers l'autre. Ton inconscient t'invite à te réconcilier avec une partie de toi.",
    ]},
  ...
  { keys:["examen","partiel","bac","contrôle","note","raté","échoué","concours","résultat","copie","révision"],
    i:[
      "Rêver d'examen raté est l'un des rêves les plus répandus — même des années après avoir quitté l'école. Il traduit une peur d'être évalué et jugé insuffisant dans n'importe quel domaine de ta vie. Ton inconscient te met à l'épreuve pour t'aider à dépasser cette peur.",
      "L'examen dans les rêves est la métaphore parfaite de la pression de performance. Ce rêve signale une situation dans ta vie où tu te sens évalué — au travail, en amour, en société. Il t'invite à te demander : est-ce que je m'impose des standards trop élevés ?",
    ]},
  { keys:["voiture","conduire","accident","frein","vitesse","route","camion","moto","véhicule","volant","chauffeur","taxi"],
    i:[
      "La voiture en rêve est un symbole de ta trajectoire de vie et de ton sentiment de contrôle sur elle. Perdre le contrôle ou avoir des freins défaillants signale une situation où tu te sens dépassé par les événements. La question clé : qui tient le volant de ta vie en ce moment ?",
      "Rêver d'accident traduit une anxiété face à la vitesse des changements dans ta vie. Ton inconscient te demande de lever le pied et de reprendre le contrôle consciemment avant que les choses t'échappent vraiment. Le véhicule est toi — prends soin de lui.",
    ]},
  { keys:["argent","billet","riche","pauvre","dette","banque","payer","dépenser","trésor","gagner","perdre"],
    i:[
      "L'argent dans les rêves représente rarement l'argent réel — il symbolise l'énergie, la valeur personnelle et le pouvoir. Trouver de l'argent signale une prise de conscience de tes propres ressources intérieures ; en perdre, une peur de ne pas être à la hauteur.",
  ...
  { keys:["parents","père","mère","famille","frère","sœur","grand-père","grand-mère","mari","femme","conjoint"],
    i:[
      "Les membres de la famille en rêve incarnent des archétypes ou des aspects de ta propre psyché. Le père symbolise l'autorité et la structure ; la mère, la protection et l'intuition. Un conflit avec eux en rêve reflète souvent un conflit avec ces principes en toi-même.",
      "Rêver de sa famille active les complexes les plus profonds de l'inconscient. Jung montrait que nos proches en rêve projettent nos propres tensions intérieures non résolues. Si la relation est conflictuelle, une partie de toi cherche à se réconcilier avec ton histoire.",
    ]},
  { keys:["perdu","perdre","chemin","boussole","direction","labyrinthe","errer","retrouver","orientation"],
    i:[
      "Être perdu en rêve exprime un sentiment de manque de direction dans ta vie éveillée — une période de transition où les repères habituels ne fonctionnent plus. Ce n'est pas un échec, c'est une invitation à trouver ta propre boussole intérieure plutôt que de suivre celle des autres.",
      "Le labyrinthe ou l'errance symbolise une quête de sens — tu cherches ton chemin dans une situation complexe sans solution évidente. Jung voyait dans ces rêves un processus d'individuation : l'âme qui cherche sa propre vérité en dehors des chemins balisés.",
    ]},
  { keys:["guerre","combat","arme","fusil","couteau","violence","blessure","sang","blessé","soldat","bataille"],
    i:[
      "La guerre ou le combat symbolise un conflit intérieur intense — deux parties de toi-même qui s'affrontent. Les armes représentent les arguments, les défenses ou les blessures émotionnelles. Ce rêve signale une tension non résolue qui demande à être reconnue et négociée.",
      "Rêver de violence traduit une énergie agressive refoulée qui cherche une sortie. Jung parlait de la confrontation nécessaire avec l'ombre. Cette agression n'est pas négative en soi — elle représente une énergie vitale qui demande à être canalisée de façon constructive.",
    ]},
  { keys:["école","classe","professeur","cours","élève","tableau","cahier","cartable","université","amphi","faculté"],
    i:[
      "L'école en rêve représente le lieu où tu es évalué et où tu apprends les règles du monde. Y retourner en rêve signale une situation dans ta vie actuelle où tu te sens à nouveau en position d'apprenti ou jugé. C'est une invitation à aborder cette situation avec curiosité plutôt qu'avec anxiété.",
      "Rêver de la salle de classe active des mémoires profondes liées au jugement et à la performance. Ton inconscient utilise ce cadre familier pour parler d'une situation présente où tu te sens observé. La leçon à retenir : tu en sais déjà plus que tu ne le crois.",
    ]},
  { keys:["téléphone","portable","appel","message","sms","réseau","internet","connexion","déconnecté","batterie"],
    i:[
      "Le téléphone symbolise la communication et le lien avec les autres — ou son absence. Ne pas pouvoir appeler, réseau absent, batterie morte : autant de métaphores d'un sentiment de déconnexion ou d'isolement que tu ressens dans ta vie éveillée.",
      "Rêver de problèmes de communication traduit une frustration dans l'expression de tes besoins ou dans ta capacité à être entendu. C'est le signe que quelque chose d'important n'est pas dit. Ton inconscient t'invite à trouver le courage de communiquer.",
    ]},
  { keys:["nu","nudité","déshabillé","sans vêtements","honte","exposé"],
    i:[
      "Rêver qu'on est nu en public traduit une peur d'être vu tel qu'on est vraiment, sans les masques sociaux. Freud y voyait le désir d'exhibitionnisme refoulé ; Jung, la peur de l'exposition de son vrai Soi. Ce rêve survient souvent avant une situation où tu vas devoir te montrer vulnérable ou authentique.",
      "La nudité en rêve parle de vulnérabilité et d'authenticité. Si les autres ne semblent pas le remarquer, c'est un signe positif — ton inconscient te dit que ta vraie nature est plus acceptée que tu ne le crois. Si tu ressens de la honte, c'est une invitation à explorer quelle partie de toi tu n'oses pas encore montrer.",
    ]},
  { keys:["voyage","train","avion","valise","partir","départ","aéroport","gare","bateau","arriver","destination","bagages"],
    i:[
      "Le voyage en rêve est une métaphore directe de ta trajectoire de vie. Le moyen de transport symbolise la façon dont tu avances. Les bagages représentent ce que tu transportes avec toi — souvenirs, responsabilités, relations. Manquer son avion signale une peur de rater une opportunité.",
      "Rêver de voyage traduit une aspiration au changement ou une transition en cours. L'aéroport ou la gare sont des espaces de passage entre deux phases de vie. Arriver à destination reflète la confiance dans tes choix ; errer sans direction, une période de questionnement sur ta route.",
    ]},
  { keys:["magie","pouvoir","super-pouvoir","sorcier","magicien","invisible","transformation","métamorphose"],
    i:[
      "La magie et les super-pouvoirs représentent des capacités que tu possèdes intérieurement mais que tu n'utilises pas encore pleinement. Être invisible symbolise un désir de liberté sans jugement ; se transformer, une flexibilité psychologique remarquable. Ces rêves sont souvent des messages de confiance en soi de ton inconscient.",
      "Rêver de pouvoirs magiques traduit un potentiel non exprimé qui cherche à se manifester. Jung voyait dans ces rêves le contact avec le Soi profond — cette partie de nous qui transcende les limites ordinaires. C'est une invitation à prendre davantage de risques créatifs.",
    ]},
  { keys:["prison","enfermé","prisonnier","cage","mur","barreaux","piégé","sortir"],
    i:[
      "La prison symbolise un sentiment d'enfermement dans ta vie — une situation, une relation ou une croyance dont tu ne vois pas comment sortir. Les barreaux représentent les limites que tu perçois, réelles ou imaginaires. La question clé que pose ce rêve : qui a la clé de cette cage ?",
      "Être piégé ou enfermé traduit une frustration profonde face à des contraintes que tu vis comme insurmontables. Freud y voyait le refoulement à l'œuvre ; Jung, la nécessité de briser des schémas répétitifs. Ce rêve est inconfortable mais précieux — il pointe exactement là où tu as besoin de te libérer.",
    ]},
  { keys:["miroir","reflet","image","double","jumeau","sosie","visage","apparence"],
    i:[
      "Le miroir en rêve est l'un des symboles les plus puissants de la conscience de soi. Ce que tu vois dans le reflet n'est pas toujours ton visage réel — c'est une vérité que ton inconscient veut te montrer sur qui tu es vraiment, au-delà des apparences.",
      "Rêver de son propre reflet active le processus jungien d'individuation — la quête de la connaissance de soi authentique. Ce miroir te pose la question fondamentale : est-ce que tu te vois vraiment tel que tu es, ou tel que tu voudrais être ? C'est une invitation à regarder en face sans filtre.",
    ]},
];
